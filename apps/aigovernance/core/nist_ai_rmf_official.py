"""Official NIST AI RMF 1.0 (AI 100-1) categories and subcategories.

Source: apps/aigovernance/docs/NIST_AI_RMF_100-1.pdf (full framework, 48 pages),
table text extracted via pdftotext on 2026-08-12 with manual verification of
line-wrap hyphenation and two-column table boundary artifacts.

Structure: 4 functions, 19 categories, 72 subcategories
(GOVERN 19, MAP 18, MEASURE 22, MANAGE 13). Category and subcategory
wording is verbatim from the official document.
"""


NIST_AI_RMF_CATEGORIES: dict[str, str] = {
...
NIST_AI_RMF_SUBCATEGORIES: dict[str, str] = {
    ...
    "MEASURE 2.4": "The functionality and behavior of the AI system and its components – as identified in the MAP function – are onitored when in production.",
